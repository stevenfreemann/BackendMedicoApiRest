...
public class DetalleConsultaController {
    ...
    @Path("/guardar")
    public Response guardar(@Valid DetalleConsulta detalleConsulta) throws ObjetcRequiredException {  
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/editar")
    public Response editar(@Valid DetalleConsultaDto detalleConsulta) throws NotFoundModelException {  
